...
public class Fix4Mistakes {
    ...
    static private List<Number> initList(List<Number> list) {
    ...
    static private void printListValues(List<Number> list) {
        for (int i = 0; i < list.size(); i++) {
            System.out.println(list.get(i));
        }
    }

    static private void processCastedObjects(List<Number> list) {

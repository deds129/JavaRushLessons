...
public class Solution2 {
    ...
    public static class  Orca extends OceanAnimal implements Swimmable{
        Swimmable getCurrentAnimal(){
            return (Swimmable)this;
        }
    ...
    public static class Whale extends OceanAnimal implements Swimmable{
        Swimmable getCurrentAnimal(){
            return (Swimmable) this;
        }
    ...
    public static class Otter implements Walkable, Swimmable{
        Swimmable getCurrentAnimal(){
            return (Swimmable) this;
        }
